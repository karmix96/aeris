"""S1 volume marching — get a volume at all, then refine.
...
import strategy_s1 as S0  # noqa: E402
...
WORK = REPO_ROOT / "AERIS_MESH_STUDY/artifacts/strategy_studies/S1_tip_first"
...
def _extreme_blocks(surface_level: str, name: str):
    sys.path.insert(0, str(STUDIES / "S0_cap4"))
...
def main() -> int:
    ...
    ap.add_argument("--surface", default="L2_smoke", choices=list(S0.LEVELS))
