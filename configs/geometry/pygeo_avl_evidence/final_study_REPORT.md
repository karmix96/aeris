...
Run directory: `/home/mike/Desktop/Start_Up/Code/v.0.1_Project/artifacts/pygeo_avl_study/final_study_20260723T160420+0300`  
...
At 17 extracted sections, the worst error against the 33-section reference over |alpha|>=4 deg was **0.161% in CL** and **0.180% in CDi**. At alpha=0 deg, where a relative percentage is ill-conditioned, the absolute differences were ΔCL=4.900e-04 and ΔCDi=1.160e-05. Every resolution used the same 64 semispan panels, so this isolates section sampling rather than panel density. See [convergence plot](section_convergence/section_convergence.png) and [CSV](section_convergence/section_convergence.csv).
